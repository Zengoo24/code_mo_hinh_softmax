...
# 1. Load dữ liệu
# ============================
data = np.load(r"E:\PythonProject\khuôn mặt_ảnh\features_static_10feats.npz")
X = data["X"]
y = data["y"]
...
joblib.dump(model_data, "softmax_model_best1.pkl")
print("✅ Đã lưu model vào 'softmax_model_best1.pkl'")
...
print("✅ Đã lưu scaler vào 'scale1.pkl'")